...
class OmniOpenAIServingSpeech(OpenAIServing, AudioMixin):
    ...
    async def _create_diffusion_speech(
        ...
        try:
            ...
            return self._diffusion_error_response(str(e), status_code=400, error_type="BadRequestError")
        except Exception as e:
    ...
    @staticmethod
    def _diffusion_error_response(message: str, status_code: int = 500, error_type: str = "server_error") -> Response:
        error_body = json.dumps({"error": {"message": message, "type": error_type, "param": None, "code": status_code}})
